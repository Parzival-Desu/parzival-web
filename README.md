# Parzival Takei - Personal Portfolio Website

Portfolio website interaktif dengan fitur games, AI chatbot, dan night mode.

## 🎮 Features

### Main Features
- **Interactive Portfolio** - Showcase 2D/3D art, models, buildings
- **Flappy Bird** - A normal Flappy Bird games
- **FPS: Maze Hunter** - A normal FPS game where you shoots the enemy `Note: The enemy will increase more and more in each wave, and sometimes can disappear when you move a tiny winy pixel, so becareful!`
- **Visual Novel** - "Afterlight Days" story experience
- **Real Typing Challenge** - Coding typing game
...
2. **Airi AI Chatbot** - Assistant yang bisa navigate website
...
- Shin Takara Jima by Sakanaction (158 BPM) - Normal
- 花になって (96 BPM) - Hard
- イージーゲーム (166 BPM) - Hard
...
All Rights Reserved © 2025 Parzival Takei

---

**For UTS Submission:**
- Course: [Pemrograman Website]
- Lecturer: [Cintiya Dewiani Putri, S.Kom., M.Kom.]
